...
class Field {
	...
	const EMAIL = 11;
	const URL = 12;
	const STRING_NORMALIZE = 13 ; //[a-zA-Z0-9_]
	const DATETIME = 14;
...
public function init() {
	switch ($this->col_type) {
		case Field::BOOLEAN : 	$this->converter=new BooleanConverter();break;
		case Field::DATE : 		$this->converter=new DateConverter();break;
		case Field::POINT : 	$this->converter=new PointConverter();break;
		case Field::INTEGER : 	$this->converter=new IntegerConverter();break;
		case Field::STRING :	$this->converter=new StringConverter();break;
		case Field::EMAIL :		$this->converter=new EmailConverter();break;
		case Field::URL :		$this->converter=new URLConverter();break;
		case Field::STRING_NORMALIZE :	$this->converter=new StringNormalizedConverter();break;
		case Field::SELECT :	$this->converter=new SelectConverter();break;
		case Field::CHOICE :	$this->converter=new ChoiceConverter();break;
		case Field::PASSWORD :	$this->converter=new PasswordConverter();break;
		case Field::IMAGE_PATH :	$this->converter=new ImageConverter();break;
		case Field::DATETIME:	$this->converter=new DateTimeConverter();break;
		case Field::AMOUNT:		$this->converter=new AmountConverter();break;
		case Field::TEXT:		$this->converter=new TextConverter();break;
		case Field::VILLE:		$this->converter=new VilleConverter();break;
		case Field::MULTICHOICE:	$this->converter=new MultiChoiceConverter();break;
		case Field::ADDRESS:	$this->converter=new AddressConverter();break;
		case Field::TIME:	$this->converter=new TimeConverter();break;
		case Field::HIDDEN:	$this->converter=new HiddenConverter();break;
		case Field::PHONE:	$this->converter=new PhoneConverter();break;
